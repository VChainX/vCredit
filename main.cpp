...
const string strMessageMagic = "vcredit Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
  ...
  {
    nSubsidy = 5670000 * COIN;
  }
    else if(pindexBest->nHeight+1 >= 2 && pindexBest->nHeight+1 <= 2043302)
  {
    nSubsidy = 100 * COIN;
  }
...
// vcredit: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "vcredit", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "vCredit Rise of Virtual Money";
        CTransaction txNew;
        txNew.nTime = 1526573656;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xf6430b0d5696eb88fe3b9ca275a587e9fef1f8d4640cb632c2bf172688d0ade0"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf2, 0xc3, 0xd5, 0xa2 };
